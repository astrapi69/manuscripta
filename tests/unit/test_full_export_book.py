...
from manuscripta.export.book import prepare_output_folder, run_script, compile_book
...
@patch("manuscripta.export.book.OUTPUT_DIR", TEST_OUTPUT_DIR)
@patch("manuscripta.export.book.BACKUP_DIR", TEST_BACKUP_DIR)
...
@patch("subprocess.run")
@patch("manuscripta.export.book.BOOK_DIR", "tests/fixtures/manuscript")
@patch("manuscripta.export.book.OUTPUT_DIR", TEST_OUTPUT_DIR)
@patch("manuscripta.export.book.METADATA_FILE", "tests/fixtures/metadata.yaml")
